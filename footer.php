    ...
    <footer>
      ...
      <div class="footer-item">
        ...
        <p>Produzido por <a class="dev" href="https://api.whatsapp.com/send/?phone=5511982495332&text=Ol%C3%A1%21+Como+podemos+te+ajudar%3F" target="_blank">Ricardo Campos</a></p>
      </div>
      <div class="footer-item">
        <h3 class="social">Redes Sociais</h3>
        <a href="https://www.instagram.com/carolcpgoncalves/" target="_blank"><i class="fab fa-instagram-square fa-2x color"></i></a>
      </div>
    </footer>
  </body>
</html>